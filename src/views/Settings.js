        ...
        <div className="p-6">
            <Link to="/">
                <button
                    ...
                    <svg className="w-6 h-6 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            {alert.visible && alert.type === 'settingsSaved' && (
                <CloseableSuccessAlert onClose={() => setAlert({ ...alert, visible: false })} message="Settings saved successfully!" />
            )}
            <label htmlFor="api-key" className="block mb-2 text-sm font-bold text-gray-900">API Key</label>
            <div className="flex">
